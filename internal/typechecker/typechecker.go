...
// srcRoot is the absolute path to the consumer's src/ directory for user module resolution.
func CheckModule(moduleName string, srcRoot string) (*ModuleResult, error) {
	...
	if strings.Contains(moduleName, ":") {
		...
		if namespace == "Std" {
			...
			// Use the package's src/ as srcRoot so inner imports
...
// srcRoot is the absolute path to the src/ directory for user module resolution (empty if not applicable).
